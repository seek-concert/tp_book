...
function leftSubNavManage(e,event){
	...
	if(hasTit){//已打开此页面
		...
		var li = '<li data-tit="'+tit+'" class="on" onmousedown="tabManage(this,event)"><img src="/Public/app/img/file_extension_log.png"/>'+tit+'<span title="关闭当前窗口" onclick="closeIframe()"></span></li>';
